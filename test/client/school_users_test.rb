...
class CleverApi::Client::SchoolUsersTest < CleverApi::Test
  def test_school_users
    VCR.use_cassette("school_users") do
      users = CleverApi.client("TEST_TOKEN").school_users("58da8c58155b940248000007")
  ...
  def test_users_with_limit
    VCR.use_cassette("school_users_with_limit") do
      users = CleverApi.client("TEST_TOKEN").school_users("58da8c58155b940248000007", limit: 25)
  ...
  def test_users_with_starting_after
    VCR.use_cassette("school_users_with_starting_after") do
      users = CleverApi.client("TEST_TOKEN").school_users("58da8c58155b940248000007", starting_after: "58da8c63d7dc0ca068000416")
  ...
  def test_users_next
    VCR.use_cassette("schoool_users_next") do
      users = CleverApi.client("TEST_TOKEN").school_users("58da8c58155b940248000007")
